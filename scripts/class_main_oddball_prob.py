...
class oddball_model:
    def main(self, dev_degree=270, Tinter=0.5, Tstim=0.5, adap_amount=0.2,
        ...
        # Randomly choose between vect1 and vect2 with corresponding probabilities
...
if __name__=="__main__":
    ...
    PltTool.PlotPyrPop(left=50,right=60, color_scale=3,flag_shade=False)
    ...
    PltTool.PlotPyrTimes_col()
    PltTool.PlotPyrTimes_pop_all_long()   # Requires param_stim['choices']
    PltTool.PlotInt(left=50,right=60)
    PltTool.PlotPyrTimes_pop_all_long(left=50, right=60)   # Requires param_stim['choices']
    PltTool.PlotPyrTimes_pop_all_long(left=0, right=10)   # Requires param_stim['choices']
