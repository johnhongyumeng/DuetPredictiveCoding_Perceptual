...
class oddball_model:
    def main(self, dev_degree=270, Tinter=0.5, Tstim=0.5, adap_amount=0.2,
        ...
        degree_vec=np.array([0,90,270,135,180,225,45,315])    
        stimuli_inc_dic=[]
        stimuli_ave_sst_dic=[]
...
#    prob_flag= True
    ...
    Output_dic=main_model.main(omission_flag=False,saving_tag=f'testing_oddball_manyctrl_normset_realistc',adap_amount=0,
...
with open(parent_dir+'\\net\\realistic\\Output_oddball_normset_realistic.pkl', 'wb') as f:
