...
if __name__=="__main__":
    ...
    '''    
    Output_dic=main_model.main(omission_flag=False,saving_tag='oddball_long',adap_amount=0,
                               Tau_int=Tau_int, Tinter=Tinter,Tstim=Tstim, nbr_rep_std=5,nbr_rep_dev=5,
                               g_IntE=g_IntE,g_back_int=g_back_int)
    ...
    PltTool.PlotPyrPop(left=-1,color_scale=3)
    PltTool.PlotPyrTimes_sample(shift_id=-PltTool.N_eachC//2)
    PltTool.PlotPyrTimes_sample(shift_id=PltTool.N_eachC//2-1)
