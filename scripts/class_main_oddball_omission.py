...
class oddball_model:
    def main(self, dev_degree=270, Tinter=0.5, Tstim=0.5,
             g_back_int=53,
...
if __name__=="__main__":
    ...
    main_model.main(Tinter=Tinter, Tstim=Tstim,Stim_g =Stim_g,
                    omission_flag=True, saving_tag='omission', Tau_int=Tau_int)
    ...
    MMNInt=PltTool.PlotInt_omiss() 
    PltTool.PlotPyrTimes_pop_omission()
    PltTool.PlotPyrTimes_col(linewidth=2)
    DD_value,n_omiss=PltTool.PlotPyrTimes_pop_omission(thr=0)
    PltTool.PlotPyrTimes_col_omiss(linewidth=2)
